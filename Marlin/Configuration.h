...
#define CUSTOM_MACHINE_NAME "Accusoft"
...
#define HOTEND_OFFSET_X {0.0, 43.06} // (in mm) for each extruder, offset of the hotend on the X axis
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 84.47, 84.36, 1046.77, 83.97, 82.90 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 300, 300, 10, 50, 50 }
/**
 ...
 *    (0,0)
 */
#define X_PROBE_OFFSET_FROM_EXTRUDER 89  // X offset: -left  +right  [of the nozzle]
...
#define  REPRAP_DISCOUNT_FULL_GRAPHIC_SMART_CONTROLLER      // Full graphics display
